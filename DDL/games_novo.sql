...
create table if not exists perfil(
    ...
    cor_pele varchar(15) not null,
    cor_cabelo varchar(15) not null,
    cor_olhos varchar(15) not null,
    cor_camisa varchar(15) not null,
...
insert into perfil values (1,'elisabete','25','elisa','feminino','branco','loiro','verde','rosa');
insert into perfil values (2,'elias','14','elias','masculino','branco','preto','preto','verde');
insert into perfil values (3,'leandro','12','leandro','masculino','pardo','castanho','castanho','preto');
insert into perfil values (4,'rogerio','17','rogerio','masculino','negro','preto','castanho','azul');
insert into perfil values (5,'ulisses','15','ulisses','masculino','branco','castanho','verde','amarelo');
insert into perfil values (6,'elisabete','25','elisa','feminino','branco','loiro','azul','vermelho');
insert into perfil values (7,'henrique','7','henrique','masculino','pardo','castanho','verde','cinza');
insert into perfil values (8,'henrique','7','henrique','masculino','negro','preto','castanho','amarelo');
insert into perfil values (9,'leandro','7','leandro2','masculino','pardo','loiro','azul','azul');
insert into perfil values (10,'elisabete','7','elisabete2','feminino','branco','ruivo','preto','vermelho');
insert into perfil values (11,'ulisses','7','ulisses2','masculino','negro','castanho','castanho','cinza');
